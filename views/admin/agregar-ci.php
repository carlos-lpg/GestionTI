...
$tipoStmt->execute();
$tipos_ci = $tipoStmt->fetchAll(PDO::FETCH_ASSOC); // Obtener todos los resultados antes de resetear el puntero
    ...
    <div class="col-12">
        <div class="form-container">
            ...
            <form action="" method="POST" id="formCI">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="tipo_ci" name="tipo_ci" required>
                                    ...
                                    <?php foreach ($tipos_ci as $tipo): // Usamos la variable $tipos_ci para iterar ?>
                ...
                <div class="card mb-4" id="hardware_section" style="display: none;">
                    <div class="card-header">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Referencia al selector de Tipo de CI
    const tipoCISelect = document.getElementById('tipo_ci');
    // Referencia a las secciones de componentes
    ...
    // ID del Tipo de CI que requiere componentes (Computadora = 2)
    const TIPO_CI_COMPUTADORA_ID = '2'; // NOTA: Tu tabla SQL dice ID 2 para Computadora

    /**
     * Alterna la visibilidad de las secciones de Componentes de Hardware y Software.
     */
    function toggleComponentSections() {
        // El valor seleccionado es un string, por lo que se compara con el string '2'
        if (tipoCISelect.value === TIPO_CI_COMPUTADORA_ID) {
    ...
    toggleComponentSections();

    // Asignar evento al cambio de Tipo de CI
    tipoCISelect.addEventListener('change', toggleComponentSections);
    ...
    function toggleInputFields(checkbox) {
        ...
        // Seleccionar solo los inputs dentro de las celdas de Cantidad y Notas (no el checkbox en la primera celda)
        const inputs = tr.querySelectorAll('td:nth-child(5) input, td:nth-child(6) input');
        
        inputs.forEach(input => {
            input.disabled = !checkbox.checked;
            if (!checkbox.checked) {
                // Restaurar valores por defecto al desmarcar
