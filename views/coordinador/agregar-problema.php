...
if (!in_array($_SESSION['user_role'], ['Técnico TI', 'Coordinador TI CEDIS', 'Coordinador TI Sucursales', 'Coordinador TI Corporativo', 'Supervisor Infraestructura', 'Supervisor Sistemas', 'admin'])) {
